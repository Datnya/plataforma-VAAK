...
async function GET() {
    ...
    const username = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$demo$2d$identities$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["usernameForEmail"])(user?.email);
    if (!user || !username) {
    ...
    const { data: membership } = await supabase.from("vaak_user_company_memberships").select("role,status").eq("user_id", user.id).eq("status", "active").limit(1).maybeSingle();
    if (!membership) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            authenticated: false
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__152mtua._.js.map