...
// Validate ../../../app/api/storage/sign/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/storage/sign">> = Specific
  const handler = {} as typeof import("../../../app/api/storage/sign/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../app/api/tracking/[token]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/tracking/[token]">> = Specific
  const handler = {} as typeof import("../../../app/api/tracking/[token]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
