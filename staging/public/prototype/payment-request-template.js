(function(root,factory){
  ...
  function render(project={},invoice={}){
    ...
    return `<article class="payment-request-preview hpg-payment-request notranslate" translate="no" lang="en">
      ...
      <section class="pr-doc-section pr-request-section"><h2>REQUEST DETAIL</h2><div class="pr-request-box"><p>${esc(value(invoice.requestDetail))}</p><aside><span>TOTAL FOR THIS REQUEST</span><strong>${money(currency,requestTotal)}</strong></aside></div></section>
