(function(root,factory){
  ...
  function render(project={},invoice={}){
    ...
    return `<article class="payment-request-preview hpg-payment-request notranslate" translate="no" lang="en">
      ...
      <section class="pr-payment-line"><p>Please make payments payable to <strong>${mk(ch('paymentPayableTo'),esc(value(paymentPayableTo)))}</strong> in the amount of:</p><strong>${mk(ch('paymentAmount'),money(currency,paymentAmount))}</strong></section>
